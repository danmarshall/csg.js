...
*/
import { addTransformationMethodsToPrototype, addCenteringToPrototype } from './src/mutators';
import CSG from './src/CSG';
import CAG from './src/CAG';
// FIXME: how many are actual usefull to be exposed as API ?? looks like a code smell
import { _CSGDEBUG, defaultResolution2D, defaultResolution3D, EPS, angleEPS, areaEPS, all, top, bottom, left, right, front, back, staticTag, getTag } from './src/constants';
