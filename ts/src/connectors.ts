...
export class Connector {
  ...
  private axisvector: Vector3D;
  private normalvector: Vector3D
...
class ConnectorList {
  ...
  static fromPath2D = function (path2D, arg1, arg2) {
   ...
   * provided.
   */
  static _fromPath2DTangents = function (path2D, start, end) {
    // path2D
    let axis
   ...
   */
  static _fromPath2DExplicit = function (path2D, angleIsh) {
