...
class Matrix4x4 {
  ...
  // (result = M*v)
  // Fourth element is taken as 1
  rightMultiply1x2Vector(v: Vector2D) {
    var v0 = v.x
    var v1 = v.y
    var v2 = 0
    var v3 = 1
  ...
  // (result = v*M)
  // Fourth element is taken as 1
  leftMultiply1x2Vector(v: Vector2D) {
    var v0 = v.x
    var v1 = v.y
    var v2 = 0
    var v3 = 1
  ...
  static unity = function () {
    return new Matrix4x4()
  }

  // Create a rotation matrix for rotating around the x axis
  static rotationX = function (degrees: number) {
  ...
  static rotationY = function (degrees: number) {
    var radians = degrees * Math.PI * (1.0 / 180.0)
    var cos = Math.cos(radians)
    var sin = Math.sin(radians)
    var els = [
  ...
  static rotationZ = function (degrees: number) {
    var radians = degrees * Math.PI * (1.0 / 180.0)
    var cos = Math.cos(radians)
    var sin = Math.sin(radians)
    var els = [
  ...
  static rotation = function (rotationCenter: Vector3D, rotationAxis: Vector3D, degrees: number) {
  ...
  static translation = function (v: Vector3D | number[]) {
  ...
  static mirroring = function (plane: Plane) {
  ...
  static scaling = function (v: Vector3D) {
    // parse as Vector3D, so we can pass an array or a Vector3D
    var vec = new Vector3D(v)
    var els = [
